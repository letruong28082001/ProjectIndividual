      ...
      <div class="sub-common-content">
        ...
        <div class="supplier-content">
          ...
          <div class="show-supplier">
            <DataTable
              v-model:first="panidaterInfo.firstPage"
              :rows="panidaterInfo.limitPage"
              :total-records="10"
              :value="suppliers"
              paginator
            >
...
function getDataSupplier(params: {
  ...
  axiosService
    ...
    .then((res) => {
      ...
      panidaterInfo.total = res.data.response.total;
      console.log(panidaterInfo.total);
...
onMounted(() => {
  getDataSupplier({ page: 1, limit: panidaterInfo.limitPage });
});
